...
set TC_C_DEFINES=-D_WIN32 -DGST_WINDOWS_DRIVER
...
copy /B /Y obj%TC_BUILD_ALT_DIR%\%TC_BUILD_ARCH_DIR%\gostcrypt.sys "%TC_COPY_DIR%\Setup Files\gostcrypt%TC_ARCH_SUFFIX%.sys" >NUL:
...
if %TC_TEST_SIGN% equ 1 (
	signtool sign /s "%TC_KERNEL_TEST_CERTIFICATE_STORE%" /n "%TC_KERNEL_TEST_CERTIFICATE_NAME%" "%TC_COPY_DIR%\Setup Files\gostcrypt%TC_ARCH_SUFFIX%.sys" >NUL:
